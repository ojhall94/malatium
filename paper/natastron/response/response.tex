...
Between these two statements -- that our method measures accurate rotation in the regions that matter, and that asteroseismology is biased towards older, not younger, stars -- we are confident that observing biases do not affect our conclusions. We’ve included a paraphrased version of the discussion as above in the paper \textbf{Methods} Section 3.4. \\
